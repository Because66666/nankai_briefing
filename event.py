...
class EventManager(object):
    ...
    event_type_map = dict()
    _event_list = [MessageReceiveEvent, UrlVerificationEvent,MessageReadEvent] ###注册的事件列表！！！
    ...
    def get_handler_with_event(token, encrypt_key):
        ...
        # build event
        # EventManager.event_type_map:::{'im.message.receive_v1': event.MessageReceiveEvent,
        #  'url_verification': event.UrlVerificationEvent}
        # event_type:::'im.message.receive_v1'
        # EventManager.event_type_map.get(event_type):::event.MessageReceiveEvent
        #EventManager.event_type_map.get(event_type)(dict_data, token, encrypt_key):::<event.MessageReceiveEvent at 0x18ada412d90>
